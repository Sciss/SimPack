/*
 * $Id: LinSimpleNumberTest.java 757 2008-04-17 17:42:53Z kiefer $
 *
 ...
 * @version $Id: LinSimpleNumberTest.java 757 2008-04-17 17:42:53Z kiefer $
 */
public class LinSimpleNumberTest extends TestCase {

	public void testSimpleLinCalculation() {
		Lin lin = new Lin(11d, 10d, 2d, 4d);
		assertNotNull(lin);
		assertTrue(lin.calculate());
		assertTrue(lin.isCalculated());
		Double result = new Double(2.0 * Math.log(10d / 11d)
				/ (Math.log(2d / 11d) + Math.log(4d / 11d)));
