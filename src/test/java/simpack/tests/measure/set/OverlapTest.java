/*
 * $Id: OverlapTest.java 757 2008-04-17 17:42:53Z kiefer $
 *
...
import simpack.measure.set.Overlap;

/**
 * @author Christoph Kiefer
 * @version $Id: OverlapTest.java 757 2008-04-17 17:42:53Z kiefer $
 */
public class OverlapTest {
	...
	public final void testCalculate() {
		o = new Overlap(s1, s2);
		Assert.assertTrue(o.calculate());
		Assert.assertTrue(o.isCalculated());
	}

	@Test
	public final void testGetSimilarity() {
		o = new Overlap(s1, s2);
		double sim = o.getSimilarity();
		Assert.assertEquals(2d / 3d, sim);
	}
