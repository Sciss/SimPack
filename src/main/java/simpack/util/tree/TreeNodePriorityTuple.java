/*
 * $Id: TreeNodePriorityTuple.java 757 2008-04-17 17:42:53Z kiefer $
 *
...
/**
 * This pairs a TreeNode and its NodePriority 
 * 
 * @author Tobias Sager
...
public class TreeNodePriorityTuple extends GenericTuple {
	 ...
	 * @param priority
	 */
	public TreeNodePriorityTuple(ITreeNode node, NodePriority priority) {
		super(node, priority);
	}
