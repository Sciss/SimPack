/*
 * $Id: JiangConrath.java 757 2008-04-17 17:42:53Z kiefer $
 *
 ...
 * measure proposed by Jay J.Jiang and David W.Conrath in "Semantic Similarity
 * Based on Corpus Statistics and Lexical Taxonomy" (1997)
 * 
 * @author Christoph Kiefer
 * @version $Revision: 752 $ $Date: 2008-04-17 19:52:02 +0200 (Thu, 17 Apr 2008) $
 */
public class JiangConrath extends AbstractSimilarityMeasure {

	static Logger logger = LogManager.getLogger(JiangConrath.class);
	 ...
	 */
	public JiangConrath(double N, double numCommons, double numElemX,
			double numElemY) {
		this.N = N;
	 ...
	 */
	public JiangConrath(IGraphAccessor graphAccessor, IGraphNode x, IGraphNode y)
			throws InvalidElementException {
