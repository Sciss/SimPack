 ...
 */
public class Overlap extends AbstractFeatureVectorSimilarityMeasure {
	 ...
	 */
	public Overlap(simpack.util.Vector<? extends Number> v1,
	...
	public boolean calculate() {
		...
		double B = Math.pow(v1.getNorm(2d), 2d);
		double C = Math.pow(v2.getNorm(2d), 2d);

		similarity = new Double(A / Math.min(B, C));
		setCalculated(true);
		return true;
	}
}
