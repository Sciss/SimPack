/*
 * $Id: Cosine.java 757 2008-04-17 17:42:53Z kiefer $
 *
 ...
 */
public class Cosine extends AbstractFeatureVectorSimilarityMeasure {
	 ...
	 */
	public Cosine(simpack.util.Vector<? extends Number> v1,
	...
	public boolean calculate() {
		setCalculated(false);
		try {
			double A = v1.getDotProduct(v2);
			double B = v1.getNorm(2d);
			double C = v2.getNorm(2d);
			similarity = new Double(A / (B * C));
			setCalculated(true);
			return true;
