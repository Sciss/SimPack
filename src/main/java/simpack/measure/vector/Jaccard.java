 ...
 */
public class Jaccard extends AbstractFeatureVectorSimilarityMeasure {
	 ...
	 */
	public Jaccard(simpack.util.Vector<? extends Number> v1,
	...
	public boolean calculate() {
		...
		double B = Math.pow(v1.getNorm(2.0), 2.0);
		double C = Math.pow(v2.getNorm(2.0), 2.0);

		similarity = new Double(A / (B + C - A));
		setCalculated(true);
		return true;
	}
}