/*
 * $Id: Manhattan.java 757 2008-04-17 17:42:53Z kiefer $
 *
 ...
 */
public class Manhattan extends AbstractFeatureVectorSimilarityMeasure {
	 ...
	 */
	public Manhattan(simpack.util.Vector<? extends Number> v1,
	...
	public boolean calculate() {
		setCalculated(false);
		try {
			double distance = v1.getManhattanDistance(v2);
