/*
 * $Id: WeightBalanceException.java 757 2008-04-17 17:42:53Z kiefer $
 *
...
/**
 * Weights given to a similarity measure are in conflict with weight balance
 * requirements for that measure.
 * 
 * @author Christoph Kiefer
 * @author Tobias Sager
 * @version $Revision: 756 $ $Date: 2008-04-17 19:52:02 +0200 (Thu, 17 Apr 2008) $
 * @see simpack.measure.sequence.Levenshtein
 */
...
public class WeightBalanceException extends RuntimeException {
	 ...
	 *            displayed message
	 */
	public WeightBalanceException(String message) {
		super(message);
	}
}