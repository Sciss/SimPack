/*
 * $Id: EditDistanceTFIDF.java 757 2008-04-17 17:42:53Z kiefer $
 *
 ...
 */
public class EditDistanceTFIDF<E> extends Levenshtein<E> {

	private static final Logger logger = LogManager
			.getLogger(EditDistanceTFIDF.class);
	 ...
	 */
	public EditDistanceTFIDF(ISequenceAccessor<E> sequenceAccessor1,
			ISequenceAccessor<E> sequenceAccessor2, StringTFIDF tfidf) {
	...
	public EditDistanceTFIDF(ISequenceAccessor<E> sequenceAccessor1,
		...
		this(sequenceAccessor1, sequenceAccessor2, DEFAULT_WEIGHT_INSERT,
				DEFAULT_WEIGHT_DELETE, DEFAULT_WEIGHT_REPLACE,
				DEFAULT_WEIGHT_REPLACE_EQUAL,
				new WorstCaseDistanceConversion(), innerThreshold, tfidf);
	}
	...
	public EditDistanceTFIDF(ISequenceAccessor<E> sequenceAccessor1,
			...
			IDistanceConversion conversion, StringTFIDF tfidf) {
		this(sequenceAccessor1, sequenceAccessor2, DEFAULT_WEIGHT_INSERT,
				DEFAULT_WEIGHT_DELETE, DEFAULT_WEIGHT_REPLACE,
				DEFAULT_WEIGHT_REPLACE_EQUAL, conversion,
				DEFAULT_INNER_TRESHOLD, tfidf);
	}
	...
	public EditDistanceTFIDF(ISequenceAccessor<E> sequenceAccessor1,
		...
		this(sequenceAccessor1, sequenceAccessor2, DEFAULT_WEIGHT_INSERT,
				DEFAULT_WEIGHT_DELETE, DEFAULT_WEIGHT_REPLACE,
				DEFAULT_WEIGHT_REPLACE_EQUAL, conversion, innerThreshold, tfidf);
	}
	...
	public EditDistanceTFIDF(ISequenceAccessor<E> sequenceAccessor1,
			...
			double innerThreshold, StringTFIDF tfidf) {
	...
	public boolean calculate() {
		...
		for (int spalte = 1; spalte <= sequenceTgt.size(); spalte++) {
			for (int zeile = 1; zeile <= sequenceSrc.size(); zeile++) {
				...
				if (tfidf.getSimilarity(str1, str2) < innerThreshold) {
		...
		logger.debug("wDist for " + sequenceSrc.toString() + "\n"
