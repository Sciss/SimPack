/*
 * $Id: SMOA.java 758 2008-04-17 17:46:50Z kiefer $
 *
 ...
 * @version $Id: SMOA.java 758 2008-04-17 17:46:50Z kiefer $
 */
public class SMOA extends AbstractSimilarityMeasure {
	 ...
	 *            the second string
	 */
	public SMOA(String str1, String str2) {
		this.str1 = str1;
		this.str2 = str2;
	}

	public SMOA(ISequenceAccessor<String> leftAccessor,
			ISequenceAccessor<String> rightAccessor) {
		this(leftAccessor.toString(), rightAccessor.toString());
	}

	public boolean calculate() {
		similarity = 1d - StringDistances.smoaDistance(str1, str2);
		return true;
	}
}