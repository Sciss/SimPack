/*
 * $Id: NeedlemanWunsch.java 757 2008-04-17 17:42:53Z kiefer $
 *
 ...
 * href="http://secondstring.sourceforge.net/javadoc/com/wcohen/secondstring/NeedlemanWunsch.html">com.wcohen.ss.NeedlemanWunsch</a>
 ...
 */
public class NeedlemanWunsch extends AbstractSecondStringSimilarityMeasure {
	...
	public NeedlemanWunsch(String str1, String str2) {
		super(com.wcohen.ss.NeedlemanWunsch.class.getName(), str1, str2);
	}
	 ...
	 * Takes two strings and returns the string edit distance as computed by <a
	 * href="http://secondstring.sourceforge.net/javadoc/com/wcohen/secondstring/NeedlemanWunsch.html">com.wcohen.ss.NeedlemanWunsch</a>.
	 * Takes additional constructor arguments that specify how the
	 * matching/mismatching is weighted.
	 * 
	 * @param str1
	 *            the first string
	 * @param str2
	 ...
	 *            characters, defaults are cost 0 for a match, -1 for a mismatch
	 * @param gapCost
	 *            the cost of inserting a gap in one string, default is 1
	 * 
	 * @see <a
	 *      href="http://secondstring.sourceforge.net/javadoc/com/wcohen/secondstring/NeedlemanWunsch.html">com.wcohen.ss.NeedlemanWunsch</a>
	 */
	public NeedlemanWunsch(String str1, String str2,
			CharMatchScore charMatchScore, double gapCost) {
		super(com.wcohen.ss.NeedlemanWunsch.class.getName(), str1, str2,
				new Class[] { CharMatchScore.class, Double.TYPE },
				new Object[] { charMatchScore, new Double(gapCost) });
	}
	 ...
	 *      href="http://secondstring.sourceforge.net/javadoc/com/wcohen/secondstring/NeedlemanWunsch.html">com.wcohen.ss.NeedlemanWunsch</a>
	 */
	public NeedlemanWunsch(ISequenceAccessor<String> leftAccessor,
