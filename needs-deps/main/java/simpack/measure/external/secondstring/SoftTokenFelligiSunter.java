/*
 * $Id: SoftTokenFelligiSunter.java 757 2008-04-17 17:42:53Z kiefer $
 *
 ...
 * href="http://secondstring.sourceforge.net/javadoc/com/wcohen/secondstring/SoftTokenFelligiSunter.html">com.wcohen.ss.SoftTokenFelligiSunter</a>
 ...
 */
public class SoftTokenFelligiSunter extends AbstractSecondStringSimilarityMeasure {
	 ...
	 *      href="http://secondstring.sourceforge.net/javadoc/com/wcohen/secondstring/SoftTokenFelligiSunter.html">com.wcohen.ss.SoftTokenFelligiSunter</a>
	 */
	public SoftTokenFelligiSunter(String str1, String str2) {
		super(com.wcohen.ss.SoftTokenFelligiSunter.class.getName(), str1, str2);
	}
	 ...
	 * @param tokenizer
	 * @param distance
	 * @param tokenMatchedThreshold
	 * @param mismatchFactor
	 * 
	 * @see <a
	 *      href="http://secondstring.sourceforge.net/javadoc/com/wcohen/secondstring/SoftTokenFelligiSunter.html">com.wcohen.ss.SoftTokenFelligiSunter</a>
	 */
	public SoftTokenFelligiSunter(String str1, String str2,
			...
			double tokenMatchedThreshold, double mismatchFactor) {
		super(com.wcohen.ss.SoftTokenFelligiSunter.class.getName(), str1, str2,
				new Class[] { Tokenizer.class, StringDistance.class,
						Double.TYPE, Double.TYPE }, new Object[] { tokenizer,
						distance, new Double(tokenMatchedThreshold),
						new Double(mismatchFactor) });
	}
	 ...
	 *      href="http://secondstring.sourceforge.net/javadoc/com/wcohen/secondstring/SoftTokenFelligiSunter.html">com.wcohen.ss.SoftTokenFelligiSunter</a>
	 */
	public SoftTokenFelligiSunter(ISequenceAccessor<String> leftAccessor,
	...
	public SoftTokenFelligiSunter(ISequenceAccessor<String> leftAccessor,
			...
			StringDistance distance, double tokenMatchedThreshold,
			double mismatchFactor) {
		this(leftAccessor.toString(), rightAccessor.toString(), tokenizer,
				distance, tokenMatchedThreshold, mismatchFactor);
	}
}