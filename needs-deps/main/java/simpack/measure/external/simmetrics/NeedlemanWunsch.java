 ...
 * href="http://www.dcs.shef.ac.uk/~sam/simmetrics/similaritymetrics/NeedlemanWunsch.html">simmetrics.similaritymetrics.NeedlemanWunch</a>
 ...
 */
public class NeedlemanWunsch extends AbstractSimMetricsSimilarityMeasure {
	...
	public NeedlemanWunsch(String str1, String str2) {
		super(simmetrics.similaritymetrics.NeedlemanWunch.class.getName(),
				str1, str2);
	}
	...
	public NeedlemanWunsch(String str1, String str2,
		...
		super(simmetrics.similaritymetrics.NeedlemanWunch.class.getName(),
				str1, str2, new Class[] { AbstractSubstitutionCost.class },
				new Object[] { costFunc });
	}
	 ...
	 *      href="http://www.dcs.shef.ac.uk/~sam/simmetrics/similaritymetrics/NeedlemanWunsch.html">simmetrics.similaritymetrics.NeedlemanWunch</a>
	 */
	public NeedlemanWunsch(String str1, String str2, float costG) {
		super(simmetrics.similaritymetrics.NeedlemanWunch.class.getName(),
				str1, str2, new Class[] { Float.TYPE }, new Object[] { costG });
	}
	...
	public NeedlemanWunsch(String str1, String str2, float costG,
			AbstractSubstitutionCost costFunc) {
		super(simmetrics.similaritymetrics.NeedlemanWunch.class.getName(),
				str1, str2, new Class[] { Float.TYPE,
						AbstractSubstitutionCost.class }, new Object[] { costG,
						costFunc });
	}
