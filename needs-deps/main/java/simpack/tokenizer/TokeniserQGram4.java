/*
 * $Id: TokeniserQGram4.java 757 2008-04-17 17:42:53Z kiefer $
 *
 ...
 * @version $Id: TokeniserQGram4.java 757 2008-04-17 17:42:53Z kiefer $
 */
public class TokeniserQGram4 implements InterfaceTokeniser, Serializable {
	...
	public Vector tokenize(String input) {
		...
		while (curPos < length) {
			final String term = input.substring(curPos, curPos + 4);
