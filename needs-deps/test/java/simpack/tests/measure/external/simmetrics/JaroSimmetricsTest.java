/*
 * $Id: JaroSimmetricsTest.java 757 2008-04-17 17:42:53Z kiefer $
 *
 ...
 * @version $Id: JaroSimmetricsTest.java 757 2008-04-17 17:42:53Z kiefer $
 */
public class JaroSimmetricsTest extends TestCase {
	...
	public void testCalculateSimilarity() {
		...
		jaro = new Jaro("test", "west");
		assertNotNull(jaro);
		assertTrue(jaro.calculate());
		assertTrue(jaro.isCalculated());
		//assertEquals(jaro.getSimilarity(), new Double(0.5));
	}
}
