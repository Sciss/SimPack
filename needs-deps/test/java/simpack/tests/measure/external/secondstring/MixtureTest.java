/*
 * $Id: MixtureTest.java 757 2008-04-17 17:42:53Z kiefer $
 *
 ...
 * @version $Id: MixtureTest.java 757 2008-04-17 17:42:53Z kiefer $
 */
public class MixtureTest extends TestCase {
	...
	public void testCalculationSimilarity() {
		...
		assertEquals(mixture.getSimilarity(), new Double(0));
	}
	
	public void testCalculationSimilarityWithParameters() {
		Mixture mixture = new Mixture("test the best", "test them", SimpleTokenizer.DEFAULT_TOKENIZER);
		assertNotNull(mixture);
		assertTrue(mixture.calculate());
		assertTrue(mixture.isCalculated());
		assertEquals(mixture.getSimilarity(), new Double(0));
