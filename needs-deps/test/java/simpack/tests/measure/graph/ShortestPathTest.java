/*
 * $Id: ShortestPathTest.java 757 2008-04-17 17:42:53Z kiefer $
 *
 ...
 * @version $Id: ShortestPathTest.java 757 2008-04-17 17:42:53Z kiefer $
 */
public class ShortestPathTest extends TestCase {
	...
	public void testShortestPath() {
		...
		assertEquals(sp.getSimilarity(), new Double(8));
	}

	public void testShortestPath2() {
		String ontClassA = "http://127.0.0.1/ontology/simplified_sumo.owl#HoofedMammal";
		String ontClassB = "http://127.0.0.1/ontology/simplified_sumo.owl#EuroDollar";
		...
		assertTrue(sp.calculate());
		assertTrue(sp.isCalculated());
		assertEquals(sp.getSimilarity(), new Double(14));
	}
	...
	public void testShortestPathMultiplePathPossible() {
		...
		assertTrue(sp.calculate());
		assertTrue(sp.isCalculated());
		assertEquals(sp.getSimilarity(), new Double(6));
	}
	...
	public void testShortestPathSameNode() {
		...
		assertTrue(sp.calculate());
		assertTrue(sp.isCalculated());
		assertEquals(sp.getSimilarity(), new Double(0));
	}
	...
	public void testShortestPathOneIsAncestorOfOther() {
		...
		assertTrue(sp.calculate());
		assertTrue(sp.isCalculated());
		assertEquals(sp.getSimilarity(), new Double(2));
	}
	...
	public void testShortestPathOneIsRootOfOntology() {
		...
		assertTrue(sp.calculate());
		assertTrue(sp.isCalculated());
		assertEquals(sp.getSimilarity(), new Double(3));
	}
